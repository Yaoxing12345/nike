    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Convert Your currency</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/currency-converter') }}">
                        ...
                        <div class="form-group">
                            <label for="to_country" class="col-md-4 control-label">From Country</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="c_amount" type="integer" class="form-control" name="c_amount" value="{{ old('c_amount') }}" required>
                            </div>
                        </div>
